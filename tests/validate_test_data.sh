...
mkdir -p "$OUTTEST"
snpseq_metadata extract runfolder -o "$OUTPATH" "$ROOTPATH/tests/resources/export/210415_A00001_0123_BXYZ321XY" json
snpseq_metadata extract snpseq-data -o "$OUTPATH" "$ROOTPATH/tests/resources/export/snpseq_data_XYZ321XY.json" json
...
snpseq_metadata export -o "$OUTTEST" "$ROOTPATH/tests/resources/export/210415_A00001_0123_BXYZ321XY.ngi.json" "$ROOTPATH/tests/resources/export/snpseq_data_XYZ321XY.ngi.json" json xml manifest tsv
